import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, toRef, version as version$1, unref, computed, defineComponent as defineComponent$1, h, isReadonly, isRef, isShallow, isReactive, toRaw, watch, onScopeDispose, Fragment, watchEffect, toRefs, capitalize, shallowRef, warn, ref, provide, camelize, createVNode, mergeProps, readonly, createElementBlock, resolveComponent, resolveDynamicComponent, Text, withCtx, createTextVNode, useSSRContext, TransitionGroup, Transition, withDirectives, vShow, resolveDirective, toDisplayString, openBlock, createBlock, renderList, nextTick, Teleport, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "hookable";
import { getContext } from "unctx";
import { sanitizeStatusCode, createError as createError$1 } from "h3";
import { hasProtocol, isScriptProtocol, joinURL, withQuery, isEqual as isEqual$1, stringifyParsedURL, stringifyQuery, parseQuery, withTrailingSlash, withoutTrailingSlash } from "ufo";
import { getActiveHead, CapoPlugin } from "unhead";
import { defineHeadPlugin } from "@unhead/shared";
import { toRouteMatcher, createRouter } from "radix3";
import { defu } from "defu";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrRenderStyle, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
if (!globalThis.$fetch) {
                      ...
                      return [
                        n === 1 ? (openBlock(), createBlock("div", { key: 0 }, [
                          createVNode("div", { class: "w-[90%] m-auto my-4" }, [
                            createVNode("p", { class: "w-full md:w-[80%] font-bold text-xl" }, " Subscribe to Udemy’s top courses "),
                          ...
                          createVNode("div", { class: "w-[90%] m-auto my-4 pb-10" }, [
                            createVNode("p", { class: "text-sm w-full md:w-[80%]" }, " Subscribe to this course and 27,000+ top‑rated Udemy courses for your organization. "),
